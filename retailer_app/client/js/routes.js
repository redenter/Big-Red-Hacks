...
this.Routes.prototype = {
  ...
  define: function() {
    ...
    Router.route('/retailers/add', function(){
        me.render(this, Template.retailSignup);
    });
    Router.route('/', function(){
        me.render(this, Template.allBranch);
    });
    Router.route('/login', function () {
        me.render(this, Template.componentHeader);
    });
        Router.route('/account', function () {
        me.render(this, Template.account, true);
    });
    Router.route('/deals/add', function () {
        me.render(this, Template.account, true);
    });
  },
